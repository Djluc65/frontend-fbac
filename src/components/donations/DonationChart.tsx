...
const DonationChart = ({
  ...
  return (
    <article className="overflow-hidden rounded-[24px] border border-slate-200/80 bg-white p-4 shadow-panel sm:p-5 lg:p-6">
      <div className="mb-4">
          ...
          {type === 'pie' ? (
            <PieChart>
              ...
              <Pie
                ...
                innerRadius={type === 'pie' ? 52 : 0}
                outerRadius={type === 'pie' ? 88 : 0}
              >
                {data.map((_, index) => (
            ...
            <BarChart data={data}>
              ...
              <XAxis dataKey={String(categoryKey)} tick={{ fill: '#64748b', fontSize: 12 }} interval="preserveStartEnd" />
